...
BEGIN TRY
    ...
    VALUES
        ...
        (
            ...
            N'/media/gallery/walnut-joinery-detail.webp',
        ...
        (
            ...
            N'/media/gallery/quiet-lounge.jpg',
        ...
        (
            ...
            N'/media/gallery/arched-dining.jpg',
            N'go-oc-cho',
        ...
        (
            ...
            N'/media/gallery/walnut-home-library.webp',
            N'hoan-thien-cong-trinh',
        ...
        (
            ...
            N'/media/gallery/walnut-suite.jpg',
            N'chia-se-chuyen-mon',
        ...
        (
            ...
            N'/media/gallery/artisan-walnut-chair.webp',
            N'su-kien',
        ...
        (
            ...
            N'/media/gallery/villa-art-wall.webp',
            N'hoan-thien-cong-trinh',
        ...
        (
            ...
            N'/media/gallery/villa-bedroom-desk.webp',
            N'go-oc-cho',
        ...
        (
            ...
            N'/media/gallery/walnut-stone-bathroom.webp',
            N'go-oc-cho',
    ...
    SELECT article.news_id,
           ...
           category.id,
           article.tags,
           CASE article.news_id
               WHEN N'WALNUT-2026-001' THEN 428
               WHEN N'WALNUT-2026-002' THEN 176
               WHEN N'WALNUT-2026-003' THEN 254
               WHEN N'WALNUT-2026-004' THEN 91
               WHEN N'WALNUT-2026-005' THEN 215
               WHEN N'WALNUT-2026-006' THEN 138
               WHEN N'WALNUT-2026-007' THEN 188
               WHEN N'WALNUT-2026-008' THEN 512
               WHEN N'WALNUT-2026-009' THEN 241
               WHEN N'WALNUT-2026-010' THEN 167
               WHEN N'WALNUT-2026-011' THEN 302
               WHEN N'WALNUT-2026-012' THEN 356
               WHEN N'WALNUT-2026-013' THEN 284
               WHEN N'WALNUT-2026-014' THEN 337
               WHEN N'WALNUT-2025-015' THEN 415
               WHEN N'WALNUT-2025-016' THEN 206
               WHEN N'WALNUT-2025-017' THEN 365
               WHEN N'WALNUT-2025-018' THEN 628
               WHEN N'WALNUT-2025-019' THEN 221
               WHEN N'WALNUT-2025-020' THEN 548
               WHEN N'WALNUT-2025-021' THEN 392
               WHEN N'WALNUT-2025-022' THEN 275
               WHEN N'WALNUT-2025-023' THEN 183
               WHEN N'WALNUT-2025-024' THEN 460
               WHEN N'WALNUT-2025-025' THEN 319
               WHEN N'WALNUT-2025-026' THEN 407
               WHEN N'WALNUT-2025-027' THEN 286
               WHEN N'WALNUT-2025-028' THEN 214
               WHEN N'WALNUT-2025-029' THEN 530
               WHEN N'WALNUT-2025-030' THEN 348
               ELSE 0
           END,
           0,
           0,
