  ...
  (function (a, b) {
    ...
    ;(a.fn.size = function () {
      ...
      (a.parseJSON = function () {
        return (
          c('jQuery.parseJSON is deprecated; use JSON.parse'), JSON.parse.apply(null, arguments)
        )
      }),
      ...
      return (
        a.each(b.match(o), function (b, e) {
          a.expr.match.bool.test(e) &&
            (c('jQuery.fn.removeAttr no longer sets boolean properties: ' + e), d.prop(e, !1))
        }),
    ...
    a.data = function (b, d, e) {
      var f
      return d && d !== a.camelCase(d) && ((f = a.hasData(b) && q.call(this, b)), f && d in f)
      ...
      return d && d.nodeType
        ? ((b = (d.ownerDocument || document).documentElement),
          a.contains(b, d)
            ...
            : (c('jQuery.fn.offset() requires an element connected to a document'), e))
    ...
    a.param = function (b, d) {
      ...
      return (
        void 0 === d &&
          e &&
          (c('jQuery.param() no longer uses jQuery.ajaxSettings.traditional'), (d = e)),
        v.call(this, b, d)
      )
    }
                  ...
                  a.each(y, function (f, g) {
                    ...
                    d[g[1]](function () {
                      ...
                      b && a.isFunction(b.promise)
                        ...
                        : c[g[0] + 'With'](this === e ? c.promise() : this, h ? [b] : arguments)
                    })
                  }),
                    (b = null)
                })
