...
import newsBanner from '../assets/img/slider/image.png'
      ...
      <div class="container">
        <div class="row">
          <div class="news-content-column" :class="viewMode === 'grid' ? 'col-md-12' : 'col-md-8'">
            ...
            <div v-if="state.totalPages > 1" class="row">
              <div class="col-md-12">
...
.news .item .con {
  margin: -155px 0px 90px;
}

#news-results {
  --news-card-image-height: 500px;
...
.news-grid-view .news-grid-card .con {
  ...
  bottom: -65px;
  -webkit-transition: bottom 0.35s cubic-bezier(0.3, 0.58, 0.55, 1);
  transition: bottom 0.35s cubic-bezier(0.3, 0.58, 0.55, 1);
}

.news-grid-card:hover .con {
  bottom: 10px;
}

.news-grid-card--popular .con,
.news-grid-card--popular:hover .con {
  bottom: auto;
}
...
@media screen and (max-width: 767px) {
  ...
  .news-grid-view .news-grid-card--popular:hover .con {
    bottom: 10px;
  }
  ...
  .news-grid-view .news-grid-card--popular .news-popular-badge {
    padding: 5px 10px;
    border-radius: 999px;
    background: #aa8453;
    color: #fff;
  ...
  .news-grid-view .news-grid-card--popular .news-popular-summary,
  .news-grid-view .news-grid-card--popular .news-popular-views {
    display: none;
  }
